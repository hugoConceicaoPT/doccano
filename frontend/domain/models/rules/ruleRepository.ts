import {
  ...
  export interface AnnotationRuleTypeRepository {
    ...
    update(projectId: string, id: number, data: Partial<AnnotationRuleTypeItem>): Promise<AnnotationRuleTypeItem>;
  ...
  export interface AnnotationRuleRepository {
    ...
    update(projectId: string, id: number, data: Partial<AnnotationRuleItem>): Promise<AnnotationRuleItem>;
  ...
  export interface VotingConfigurationRepository {
    ...
    update(projectId: string, id: number, data: Partial<VotingConfigurationItem>): Promise<VotingConfigurationItem>;
  }
