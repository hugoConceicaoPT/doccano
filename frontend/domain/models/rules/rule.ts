...
export class AnnotationRuleItem {
  ...
  static async list(
    repository: AnnotationRuleRepository,
    projectId: string
...
export class VotingConfigurationItem {
  ...
  static async findById(
    repository: VotingConfigurationRepository,
    projectId: string,
    id: number
  ): Promise<VotingConfigurationItem | null> {
...
export class AnnotationRuleAnswerItem {
  ...
  static create(
    ...
    return new AnnotationRuleAnswerItem(0, annotation_rule, member, answer)
  }

  static async list(
    repository: AnnotationRuleAnswerRepository,
    projectId: string,
